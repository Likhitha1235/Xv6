...
// swap.c
void            swapinit(void);
void            swapinitproc(struct proc *);
void            swapfreeproc(struct proc *);
int             swapout(struct proc *, uint64);
int             swapin(struct proc *, uint64);
void            mru_init(void);
void            mru_add(struct proc *, uint64);
void            mru_remove(struct proc *, uint64);
void            mru_update(struct proc *, uint64);
struct mrunode* mru_evict(void);
void            mru_ensure_capacity(void);
void            mru_dump(void);
int             getpagestat_k(int, struct pagestat *);
// Task 2 End
